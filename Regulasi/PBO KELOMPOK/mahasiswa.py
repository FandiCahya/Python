...
class Mahasiswa:
    ...
    def insert_mhs(nim, nama, kelas, alamat, hp,dosen,instansi):
        try:
            sql = "INSERT INTO mahasiswa (nim, nama, kelas, alamat, hp, dosen,instansi) VALUES (%s, %s, %s, %s, %s, %s)"
            val = (nim, nama, kelas, alamat, hp,dosen,instansi)
            cursor.execute(sql, val)
