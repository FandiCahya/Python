...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_mhs.setGeometry(QtCore.QRect(200, 415, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_lihat_instansi.clicked.connect(self.lihat)
        self.btn_mhs.clicked.connect(self.lihat2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_mhs.setText(_translate("MainWindow", "Lihat Mhs"))
