...
import dashboard_dosen as dosen
...
class Ui_Form(object):
    ...
    def tampil(self, data_mhs):
        ...
        for row, mahasiswa in enumerate(data_mhs):
...
if __name__ == "__main__":
    ...
    data_mhs = mahasiswa_instance.tampil()
    ui.tampil(data_mhs)
    Form.show()
    sys.exit(app.exec_())
